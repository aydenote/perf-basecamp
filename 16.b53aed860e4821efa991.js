(self["webpackChunkfrontend_performance_basecamp"] = self["webpackChunkfrontend_performance_basecamp"] || []).push([[16],{
...
const API_KEY = "nn7KNAI3zua2GaBr7FXdYgoPPnrBqjqT";
if (!API_KEY) {
...
const cache = {};
const saveInCache = (key, value, ttl) => {
    cache[key] = {
        value,
        expiry: Date.now() + ttl
    };
    ...
    (0,react.useEffect)(() => {
        const fetchTrending = () => useGifSearch_awaiter(void 0, void 0, void 0, function* () {
            ...
            try {
                ...
                saveInCache('trending', gifs, 24 * 60 * 60 * 1000);
                setGifList(gifs);
            }
            catch (error) {
                handleError(error);
...
//# sourceMappingURL=16.b53aed860e4821efa991.js.map